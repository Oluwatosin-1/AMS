...
def start_training(request, module_id):
    ...
    return render(
        request,
        "trainings/start_training.html",
        {"module": module, "videos": page_videos},
    )
...
def delete_training_module(request, pk):
    ...
    if request.method == "POST":
        ...
        )  # Adjust to your training module list view name
...
def feedback(request):
    ...
    submitted_feedback = Feedback.objects.filter(user=request.user).select_related(
        "module"
    )
    ...
    return render(
        request,
        "trainings/feedback.html",
        {"modules": training_modules, "submitted_feedback": submitted_feedback},
    )
...
def feedback_list(request):
    ...
    """
    feedbacks = Feedback.objects.select_related("user", "module").order_by(
        "-created_at"
    )

...
urlpatterns = [
    path(
        ...
        delete_training_module,
        name="training_trainingmodule_delete",
    ),
    ...
    path(
        "complete-training/<int:module_id>/",
        complete_training_module,
        name="complete_training_module",
    ),
    path(
        "verify-training/<int:progress_id>/",
        verify_training_completion,
        name="verify_training_completion",
    ),
]

...
class AffiliateAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('calculate_total_earnings', 'get_rank_title', 'created_at', 'updated_at')
    fieldsets = (
        ("Affiliate Details", {
            'fields': ('user', 'referred_by', 'commission_rate', 'training_completed', 'payout_threshold')
        }),
...
class AffiliateEarningAdmin(admin.ModelAdmin):
    ...
    search_fields = ('affiliate__user__username', 'affiliate__user__email', 'description')

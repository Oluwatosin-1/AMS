...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {'fields': ('user',)}),
        ('Contact Info', {'fields': ('phone_number', 'address', 'city', 'state', 'country')}),
        ('Payment Info', {'fields': ('preferred_payment_method', 'bank_account_details', 'tax_identification_number')}),

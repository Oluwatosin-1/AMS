...
class UserProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column(
                    "tax_identification_number", css_class="form-group col-md-6 mb-0"
                ),
                Column(
                    "preferred_payment_method", css_class="form-group col-md-6 mb-0"
                ),
            ),
            Row(
            ...
            Submit(
                "submit", "Save Profile", css_class="btn btn-primary btn-block mt-3"
            ),
        )

...
class ProductAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("SEO and Keywords", {"fields": ("keywords",)}),
...
class SalesHistoryAdminView(admin.ModelAdmin):
    ...
    def get_urls(self):
        ...
        custom_urls = [
            path(
                "sales-history/",
                self.admin_site.admin_view(self.sales_history_view),
                name="sales_history",
            ),
        ]
    ...
    def sales_history_view(self, request):
        ...
        # Aggregate data
        sales_data = (
            ProductPurchase.objects.filter(is_paid=True)
            .values("affiliate__user__username", "product__name")
            .annotate(

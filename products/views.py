...
class ProductDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if ref:
            ...
            try:
                ...
                context['affiliate_name'] = affiliate.user.get_full_name()  # Assuming 'user' has first_name and last_name
        ...
        if self.request.user.is_authenticated and self.request.user.user_type == 'affiliate':
    ...
    def post(self, request, *args, **kwargs):
        ...
        if response.status_code == 200:
            ...
            return render(request, 'products/payment_failed.html', {"error": error_message})
...
class PurchaseSuccessView(View):
    def get(self, request, *args, **kwargs):
        ...
        if not purchase_id:
            return render(request, "products/payment_failed.html", {"error": "Purchase not found."})
...
def store(request):
    ...
    for product in products:
        ...
        try:
            link = AffiliateProductLink.objects.get(affiliate=affiliate, product=product)
